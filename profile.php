      ...
      <div class="page-aside-inner">
        <section class="page-aside-section">
          ...
          <div class="list-group">
            <a class="list-group-item active" href="javascript:void(0)"><i class="icon md-account" aria-hidden="true"></i>About</a>
		...
		<div class="col-lg-8">
			<div class="panel panel-bordered"> 
				...
				<div class="panel-body">
				  ...
				  <p>Here is a simple samury of your status ever since you joined uPlus, the total investiment 
				  describes how much you have invested and the total return describes who much 
				  you have got from that investment.</p>
				  <div class="row text-center margin-vertical-20">
					<div class="col-xs-4">
					  <div class="counter">
						<div class="counter-label">TOTAL INVESTIMENT</div>
						<div class="counter-number red-600">
						<?PHP 
							$investment = rand(10000,80000);
					...
					<div class="col-xs-4">
					  <div class="counter">
						<div class="counter-label">TODAY RETURN</div>
						<div class="counter-number red-600"><?php echo number_format($return); ?> Rwf</div>
					  </div>
					</div>
					<div class="col-xs-4">
					  <div class="counter">
						<div class="counter-label">PERCENT</div>
						<div class="counter-number red-600"><?php echo number_format($percent);?>%</div>
					  </div>
					</div>
				</div>
